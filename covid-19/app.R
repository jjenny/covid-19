...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      selectizeInput("states1", "States (over 3000 cases):", 
                     states$over3000, 
                     multiple=TRUE, 
                     select = c(head(states$over3000, n=3), "MA")),
      selectizeInput("states2", "States (over 1000 cases):", 
                     states$over1000, 
                     multiple=TRUE),
      selectizeInput("states3", "States (over 500 cases):", 
                     states$over500, 
                     multiple=TRUE),
    ...
    mainPanel(
      ...
      p("Updated 2020-04-12 at 10:02 PM"),
      tabsetPanel(type = "tabs",
        ...
        tabPanel("Growth Rate (%)", 
                 br(),
                 #plotOutput(outputId = "growthPlot")
